...
public sealed class QuestCommand : IConsoleCommand
{
    ...
    public string Usage => "quest <start|set|stage|advance|markers|track> <questId> [state|n|next]";
    public string Summary => "Start, set the state or stage of, advance, track, or show the markers of a quest.";
